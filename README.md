...
- **Customizable AI providers**: Choose from OpenAI, Google Gemini, Mistral, or MiniMax (local LLM support coming soon)
...
- **MiniMax**: `MINIMAX_MODEL_NAME` and `MINIMAX_API_KEY`
